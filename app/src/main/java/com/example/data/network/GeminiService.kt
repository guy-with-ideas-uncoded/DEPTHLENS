...
data class InlineData(
    val mimeType: String,
    val data: String // Base64 representation of the media content
)
...
object RetrofitClient {
    ...
    private val okHttpClient = OkHttpClient.Builder()
        ...
        .addInterceptor { chain ->
            ...
            if (urlString.contains("/models/models/") || urlString.contains("/models/models%2F") || urlString.contains("/models/models%2f")) {
                val newUrlString = urlString
                    .replace("/models/models/", "/models/")
                    .replace("/models/models%2F", "/models/")
                    .replace("/models/models%2f", "/models/")
                chain.proceed(request.newBuilder().url(newUrlString).build())
            } else {
